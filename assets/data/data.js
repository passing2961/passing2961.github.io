  ...
  publications: {
    ...
    conference: [
      ...
      { id: "structure", title: "Structure Liberates: How Constrained Sensemaking Produces More Novel Research Output",
        ...
        links: {
          project: "https://minnesotanlp.github.io/SciSense/",
          paper: "https://arxiv.org/abs/2605.00557",
          code: "https://github.com/minnesotanlp/SciSense",
          dataset: "https://huggingface.co/datasets/minnesotanlp/SciSense",
          models: "https://huggingface.co/collections/minnesotanlp/scisense",
        } },
      { id: "refinebench", title: "RefineBench: Evaluating Refinement Capability in Language Models",
        ...
        links: {
          project: "https://passing2961.github.io/refinebench-page/",
          paper: "https://arxiv.org/abs/2511.22173",
          code: "https://github.com/RefineBench/refinebench-eval",
          dataset: "https://huggingface.co/datasets/RefineBench/RefineBench",
        } },
      { id: "assurai", title: "AssurAI: Experience with Constructing Korean Socio-cultural Datasets to Discover Potential Risks of Generative AI",
        ...
        venue: "arXiv preprint", note: "",
        links: {
          paper: "https://arxiv.org/abs/2511.20686",
          dataset: "https://huggingface.co/datasets/TTA01/AssurAI",
        } },
      ...
      { id: "multiverse", title: "MultiVerse: A Multi-Turn Conversation Benchmark for Evaluating Large Vision and Language Models",
        ...
        links: {
          paper: "https://openaccess.thecvf.com/content/ICCV2025/html/Lee_MultiVerse_A_Multi-Turn_Conversation_Benchmark_for_Evaluating_Large_Vision_and_ICCV_2025_paper.html",
          code: "https://github.com/passing2961/MultiVerse",
          dataset: "https://huggingface.co/datasets/passing2961/MultiVerse",
        } },
      { id: "skillofmind", title: "Enhancing Conversational Agents with Skill-of-Mind-Infused Large Language Model",
        ...
        links: {
          paper: "https://arxiv.org/abs/2411.04496",
          code: "https://github.com/passing2961/Thanos",
          dataset: "https://huggingface.co/datasets/passing2961/multifaceted-skill-of-mind",
          models: "https://huggingface.co/collections/passing2961/thanos-6711f7a74227c6088d5d88f8",
        } },
      { id: "intriguing", title: "Intriguing Properties of Large Language and Vision Models",
        ...
        venue: "arXiv preprint, 2024", note: "",
        links: {
          paper: "https://arxiv.org/abs/2410.04751",
      ...
      { id: "stark", title: "Stark: Social Long-Term Multi-Modal Conversation with Persona Commonsense Knowledge",
        ...
        links: {
          project: "https://stark-dataset.github.io/",
          paper: "https://aclanthology.org/2024.findings-emnlp.708/",
          code: "https://github.com/passing2961/Stark",
          dataset: "https://huggingface.co/collections/passing2961/stark-6729a40126cec81fa24cd09d",
          models: "https://huggingface.co/collections/passing2961/ultron-6729a47f889b63ca1e5a40c0",
        } },
      { id: "argfin", title: "Enhancing Arguments Recognition for Financial Mathematical Reasoning over Hybrid Data",
        ...
        venue: "EMNLP 2024 (Findings)", note: "",
        links: { paper: "https://aclanthology.org/2024.findings-emnlp.228/" } },
      { id: "incompletesyntax", title: "Does Incomplete Syntax Influence Korean Language Model? Focusing on Word Order and Case Markers",
        ...
        links: {
          paper: "https://openreview.net/forum?id=yfyHxvVzZT",
          code: "https://github.com/grayapple-git/SIKO",
          dataset: "https://huggingface.co/datasets/grayapple/SIKO",
        } },
      { id: "shareimages", title: "Large Language Models Can Share Images, Too!",
        ...
        links: {
          paper: "https://aclanthology.org/2024.findings-acl.39/",
          code: "https://github.com/passing2961/DribeR",
          dataset: "https://huggingface.co/datasets/passing2961/photochat_plus",
        } },
      { id: "dialogcc", title: "DialogCC: An Automated Pipeline for Creating High-Quality Multi-Modal Dialogue Dataset",
        ...
        links: {
          ...
          paper: "https://aclanthology.org/2024.naacl-long.108/",
          code: "https://github.com/passing2961/DialogCC",
          dataset: "https://huggingface.co/datasets/passing2961/dialogcc",
        } },
      { id: "debias", title: "A Simple Debiasing Framework for Out-of-Distribution Detection in Human Action Recognition",
        ...
        links: {
          paper: "https://doi.org/10.3233/FAIA230511",
          code: "https://github.com/Simcs/attention-masking",
        } },
      { id: "ambiguity", title: "Semantic Ambiguity Detection in Sentence Classification Using Task-Specific Embeddings",
        ...
        links: { paper: "https://aclanthology.org/2023.acl-industry.41/" } },
      { id: "gpt3empathy", title: "Does GPT-3 Generate Empathetic Dialogues? A Novel In-Context Example Selection Method and Automatic Evaluation Metric for Empathetic Dialogue Generation",
        ...
        links: {
          paper: "https://aclanthology.org/2022.coling-1.56/",
          code: "https://github.com/passing2961/EmpGPT-3",
          models: "https://drive.google.com/drive/folders/1PXqmv-MZ1uphHvV81htuAhid2uKGGeGd?usp=share_link",
        } },
      { id: "koreanemotion", title: "Korean-Specific Emotion Annotation Procedure Using N-Gram-Based Distant Supervision and Korean-Specific-Feature-Based Distant Supervision",
        ...
        links: {
          paper: "https://aclanthology.org/2020.lrec-1.199/",
          dataset: "https://github.com/passing2961/KMRE",
        } },
      { id: "responsegen", title: "Deep Learning Based Response Generation Using Emotion Feature Extraction",
        ...
        links: { paper: "https://doi.org/10.1109/BigComp48618.2020.00-65" } },
    ],
    journal: [
    ...
    workshop: [
      ...
      { id: "zscotempathy", title: "Investigating the Effects of Zero-Shot Chain-of-Thought on Empathetic Dialogue Generation",
        ...
        links: { paper: "https://openreview.net/forum?id=eBu11K7THc" } },
      { id: "augfin", title: "Augmentation for Context in Financial Numerical Reasoning over Textual and Tabular Data with Large-Scale Language Model",
        ...
        venue: "Instruction Workshop @ NeurIPS 2023", note: "",
        links: { paper: "https://openreview.net/forum?id=s0rM4hWBUq" } },
      { id: "personachatgen", title: "PersonaChatGen: Generating Personalized Dialogues Using GPT-3",
        ...
        links: {
          paper: "https://aclanthology.org/2022.ccgpk-1.4/",
          code: "https://github.com/passing2961/PersonaChatGen",
          dataset: "https://drive.google.com/drive/folders/146MR4ODZ51eesK17R6LorrG9bzX-zxPs?usp=share_link",
        } },
    ],
  },
